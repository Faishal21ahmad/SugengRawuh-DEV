                ...
                <div class="p-6 space-y-6">
                    <form action="/kategori" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center p-2 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600 mt-4">
                            <button type="button" class="closeModal text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-auto mt-4" >close</button>
