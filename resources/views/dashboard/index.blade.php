...
<div class="container">
    ...
    <div class="flex items-center">
        <a href="#" class="block max-w-lg p-6 m-2 flex-auto  bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <p class="font-normal text-gray-700 dark:text-gray-400 text-center">Menu Terjual</p>
        </a>
        <a href="#" class="block max-w-lg p-6 m-2 flex-auto  bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h5 class="mb-2 text-8xl font-bold text-center tracking-tight text-gray-900 dark:text-white">10</h5>
        ...
        <a href="#" class="block max-w-lg p-6 m-2 flex-auto  bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h5 class="mb-2 text-8xl font-bold text-center tracking-tight text-gray-900 dark:text-white">10</h5>
            <p class="font-normal text-gray-700 dark:text-gray-400 text-center">Pesan Masuk</p>
        </a>
        <a href="#" class="block h-44 py-12 m-2 flex-auto  bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h5 class="mb-2 text-5xl font-bold text-center tracking-tight text-gray-900 dark:text-white">Rp. 9.000.000</h5>
            <p class="font-normal text-gray-700 dark:text-gray-400 text-center">Uang Masuk</p>
        </a>
    </div>
    ...
    {{-- Card Top Seller --}}
    <ul class="flex">
        <li class="h-80 w-96 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
