...
<form action="/DS" method="POST">
    ...
    {{-- Pilih Meja --}}
    <div class="w-full h-24 bg-slate-800 absolute bottom-0 mb-44 -ml-6">
        <div class="mx-4 mb-2">
            <h3 class="p-2 text-lg font-medium text-gray-900 dark:text-white">Pilih Meja</h3>
            <ul class="justify-items-start overflow-x-auto flex flex-nowrap object-cover">
                {{-- Nomor meja --}}
                <li class="mx-1">
                    <input type="radio" id="Meja1" name="Meja_id" value="1" class="hidden peer">
                    <label for="Meja1" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-blue-600 rounded-lg cursor-pointer 
                    ...
                    peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                        <div class="block">
                            <P class="w-full text-white text-lg font-semibold">1</P>
                        </div>
                    </label>
                </li>
                <li class="mx-1">
                    <input type="radio" id="Meja2" name="Meja_id" value="2" class="hidden peer" >
                    <label for="Meja2" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-blue-600 rounded-lg cursor-pointer 
                        dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                    peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                        <div class="block">
                            <P class="w-full text-white text-lg font-semibold">2</P>
                        </div>
                    </label>
                </li>
                <li class="mx-1">
                    <input type="radio" id="Meja3" name="Meja_id" value="3" class="hidden peer" >
                    <label for="Meja3" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-blue-600 rounded-lg cursor-pointer 
                        dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                    peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                        <div class="block">
                            <P class="w-full text-white text-lg font-semibold">3</P>
                        </div>
                    </label>
                </li>
                <li class="mx-1">
                    <input type="radio" id="Meja4" name="Meja_id" value="4" class="hidden peer" >
                    <label for="Meja4" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-blue-600 rounded-lg cursor-pointer 
                        dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                    peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                        <div class="block">
                            <P class="w-full text-white text-lg font-semibold">4</P>
                        </div>
                    </label>
                </li>
                <li class="mx-1">
                    <input type="radio" id="Meja5" name="Meja_id" value="5" class="hidden peer" >
                    <label for="Meja5" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-blue-600 rounded-lg cursor-pointer 
                        dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                    peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                        <div class="block">
                            <P class="w-full text-white text-lg font-semibold">5</P>
                        </div>
                    </label>
                </li>
                <li class="mx-1">
                    <input type="radio" id="Meja6" name="Meja_id" value="6" class="hidden peer" >
                    <label for="Meja6" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-blue-600 rounded-lg cursor-pointer 
                        dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                    peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                        <div class="block">
                            <P class="w-full text-white text-lg font-semibold">6</P>
                        </div>
                    </label>
                </li>
                {{-- Nomor Meja Disable --}}
                <li class="mx-1">
                    <input type="radio" id="Meja7" name="Meja_id" value="7" class="hidden peer" disabled>
                    <label for="Meja7" class="inline-flex items-center justify-between px-4 py-2 bg-white border border-gray-300 rounded-lg cursor-pointer 
                        dark:hover:text-gray-300 dark:border-slate-300-600 dark:bg-gray-300 ">                           
                        <div class="block">
                            <P class="w-full text-black text-lg font-semibold">7</P>
                        </div>
                    </label>
                </li>
        </div>
    ...
    <div class="px-5 w-full h-16 bg-slate-800 absolute bottom-0 mb-2 -ml-6 flex">
        <div class="w-3/4 h-14 flex justify-between text-white">
            ...
            {{-- Total harga --}}
            <p class="font-bold text-lg text-end py-3 mr-3">Rp.45000</p>
        </div>
...
{{-- <div class="mt-4 h-96 overflow-y-auto scrollbar-hide"  aria-labelledby="dropdownSearchButton" id="listmenu">
    ...
    for ($i = 1; $i <= 20; $i++) {
        ?>
    <div class="hidden p-2 my-1 rounded-lg  bg-gray-50 dark:bg-gray-700 flex flex-auto">
