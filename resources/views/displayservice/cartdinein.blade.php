        ...
        <div class="w-full h-24 bg-slate-800 absolute bottom-0 mb-44 -ml-6">
            <div class="mx-4 mb-2">
                ...
                <ul class="justify-items-start overflow-x-auto flex flex-nowrap object-cover">
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja1" name="Meja_id" value="1" class="hidden peer" checked>
                        <label for="Meja1" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja2" name="Meja_id" value="2" class="hidden peer" checked>
                        <label for="Meja2" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                         dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                        peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                            <div class="block">
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja3" name="Meja_id" value="3" class="hidden peer" checked>
                        <label for="Meja3" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                         dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                        peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                            <div class="block">
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja4" name="Meja_id" value="4" class="hidden peer" checked>
                        <label for="Meja4" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                         dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                        peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                            <div class="block">
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja5" name="Meja_id" value="5" class="hidden peer" checked>
                        <label for="Meja5" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                         dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                        peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                            <div class="block">
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja6" name="Meja_id" value="6" class="hidden peer" checked>
                        <label for="Meja6" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                         dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                        peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                            <div class="block">
                    ...
                    <li class="mx-1">
                        <input type="radio" id="Meja7" name="Meja_id" value="7" class="hidden peer" checked>
                        <label for="Meja7" class="inline-flex items-center justify-between px-4 py-2 text-white bg-white border border-blue-600 rounded-lg cursor-pointer 
                         dark:hover:text-gray-300 dark:border-blue-600 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 
                        peer-checked:bg-blue-600 dark:text-gray-400 dark:bg-gray-800 ">                           
                            <div class="block">
                                <P class="w-full text-white text-lg font-semibold">7</P>
                            </div>
                        </label>
                    </li>
            </div>
